...
//    异步加载数据
function loadPhp(){
        $("#vedio-id").click(function(){
			$('.index5-nav .index3_content').show();
            $('.index5-nav .index3_content').load('data/souhushipin1.php');
            $('.index5-nav .index5_content').hide();
        });
        $("#women-id").click(function(){			
			$('.index5-nav .index3_content').show();
            $('.index5-nav .index3_content').load('data/shipinshow.php');
            $('.index5-nav .index5_content').hide();
        });
		$("#tielu-id").click(function(){
			 $('.index5-nav .index3_content').show();
             $('.index5-nav .index3_content').load('data/tielu.php');
             $('.index5-nav .index5_content').hide();
        });
		$("#hotel-id").click(function(){
			 $('.index5-nav .index3_content').show();
             $('.index5-nav .index3_content').load('data/hotel.php');
             $('.index5-nav .index5_content').hide();
        });
		$("#flight-id").click(function(){
			 $('.index5-nav .index3_content').show();
             $('.index5-nav .index3_content').load('data/flight.php');
             $('.index5-nav .index5_content').hide();
        });
        $("#mall-id").click(function(){
            $('.index5-nav .index3_content').show();
            $('.index5-nav .index3_content').load('txt/mall.php');
            $('.index5-nav .index5_content').hide();
        });
}
